...
/**
 * 継承(inheritance)を利用した「0オリジンではなく、1オリジン」でアクセスする群れオブジェクト（Bevy：べヴィ）。
 */
@SuppressWarnings("serial")
public class Bevy<Element> extends ArrayList<Element>
{
	/**
	...
	public Element at(Integer anIndex)
	{
		...
		return super.get(anIndex.intValue()-1); // ちゃんと実装してください。
	}
	...
	public Element atPut(Integer anIndex, Element anElement)
	{
		...
		return super.set(anIndex.intValue()-1, anElement); // ちゃんと実装してください。
	}
	...
	{
		return super.add(anElement); // ちゃんと実装してください。
	}
	...
	{
		return numberOfElements() - 1 < 0; // ちゃんと実装してください。
	}
	...
	{
		return Integer.valueOf(super.size()); // ちゃんと実装してください。
	}
	...
	public Element removeAt(Integer anIndex)
	{
		...
		return super.remove(anIndex.intValue()-1); // ちゃんと実装してください。
	}
