...
public class Bevy<Element> extends Object implements Iterable<Element>
{
	...
	public Element at(Integer anIndex)
	{
		...
		return this.arrayList.get(anIndex.intValue()-1); // ちゃんと実装してください。
	}
	...
	public Element atPut(Integer anIndex, Element anElement)
	{
		...
		return this.arrayList.set(anIndex.intValue()-1, anElement); // ちゃんと実装してください。
	}
	...
	{
		return this.arrayList.add(anElement); // ちゃんと実装してください。
	}
	...
	{
		return this.numberOfElements() - 1 < 0; // ちゃんと実装してください。
	}
	...
	{
		return Integer.valueOf(this.arrayList.size()); // ちゃんと実装してください。
	}
	...
	public Element removeAt(Integer anIndex)
	{
		...
		return this.arrayList.remove(anIndex.intValue()-1); // ちゃんと実装してください。
	}
